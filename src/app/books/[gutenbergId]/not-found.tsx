...
export default function NotFound() {
  ...
  const { data: bookId, isLoading: isLoadingId } = api.book.getBookIdByGutenbergId.useQuery(gutenbergId, {
    retry: false,
    enabled: !!gutenbergId,
  });

  const { data: book, isLoading: isLoadingBook } = api.book.getById.useQuery(bookId ?? "", {
    enabled: !!bookId,
  });
  ...
  const isLoading = isLoadingId || isLoadingBook;
